...
for(let i = 0; i < posts.length; i++){
    let postsIesimo = posts[i];
    const contenitore = document.getElementById("container");
    
    const element = `<div class="post">
    <div class="post__header">
        <div class="post-meta">                    
            <div class="post-meta__icon">
                <img class="profile-pic" src="${postsIesimo.author.image} " alt="Phil Mangione">                    
            </div>
            <div class="post-meta__data">
                <div class="post-meta__author">${postsIesimo.author.name} </div>
                <div class="post-meta__time">${postsIesimo.created} </div>
            </div>                    
        </div>
    </div>
    ...
    <div class="post__footer">
        <div class="likes js-likes">
            ...
            <div class="likes__counter">
                Piace a <b id="like-counter-1" class="js-likes-counter">${postsIesimo.likes} </b> persone
            </div>
        </div> 
    </div>            
</div> -->`;   
